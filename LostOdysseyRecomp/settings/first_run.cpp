...
struct Setup
{
    ...
    void translate()
    {
        ...
        items(2, {L"Direct3D 12", L"Vulkan", Translate(config.uiLanguage, L"Direct3D 11 (probe)", L"Direct3D 11（探測）")}, backend);
    ...
    void create()
    {
        ...
        items(2, {L"Direct3D 12", L"Vulkan", Translate(config.uiLanguage, L"Direct3D 11 (probe)", L"Direct3D 11（探測）")}, int(config.graphicsBackend));
