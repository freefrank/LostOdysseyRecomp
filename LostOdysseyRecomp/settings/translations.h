...
static inline const wchar_t *Translate(uint32_t language, const wchar_t *en, const wchar_t *traditional)
{
    ...
    static constexpr Entry entries[] = {
        ...
        {L"Reconstructs high-resolution frames using NVIDIA DLSS.",
         L"NVIDIA DLSS を使用して高解像度フレームを再構成します。",
         L"NVIDIA DLSS를 사용하여 고해상도 프레임을 재구성합니다.",
         L"使用 NVIDIA DLSS 重建高分辨率画面。"},
        {L"Balances image quality and performance for DLSS reconstruction.",
         L"DLSS 再構成の画質とパフォーマンスのバランスを調整します。",
         L"DLSS 재구성의 화질과 성능 간 균형을 설정합니다.",
         L"调整 DLSS 重建的画质与性能平衡。"},
