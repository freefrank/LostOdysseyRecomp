...
inline const wchar_t *Translate(uint32_t language, const wchar_t *en, const wchar_t *traditional)
{
    ...
    static constexpr Entry entries[] = {
        ...
        {L"High", L"高", L"높음", L"高"},
        {L"Matches window output automatically. Internal size is fixed; quality changes only spatial filtering.",
         L"ウィンドウ出力に自動適合します。内部解像度は固定で、品質は空間フィルターのみ変更します。",
         L"창 출력에 자동으로 맞춥니다. 내부 해상도는 고정되며 품질은 공간 필터만 변경합니다.",
         L"自动匹配窗口输出。内部分辨率固定，质量仅改变空间采样滤镜。"},
