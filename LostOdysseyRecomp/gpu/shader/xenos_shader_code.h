#pragma once
// Xenos shader microcode bitfield layouts.
// Adapted from XenosRecomp (hedge-dev, MIT License, Copyright (c) 2025
// hedge-dev and contributors) shader_code.h; field semantics cross-checked
// against Xenia's ucode.h (BSD).
...
namespace xenos
{
    ...
    struct VertexFetchInstruction
    {
        ...
        struct
        {
            ...
            uint32_t formatCompAll : 1;     // 1 = signed components
            uint32_t numFormatAll : 1;      // 0 = normalized fraction, 1 = integer
        ...
        struct
        {
            uint32_t stride : 8;            // dwords
            int32_t offset : 23;            // dwords
    ...
    {
        Adds = 0, AddsPrev = 1, Muls = 2, MulsPrev = 3, MulsPrev2 = 4, Maxs = 5, Mins = 6,
        Seqs = 7, Sgts = 8, Sges = 9, Snes = 10, Frcs = 11, Truncs = 12, Floors = 13,
        Exp = 14, Logc = 15, Log = 16, Rcpc = 17, Rcpf = 18, Rcp = 19, Rsqc = 20, Rsqf = 21, Rsq = 22,
        MaxAs = 23, MaxAsf = 24, Subs = 25, SubsPrev = 26,
        SetpEq = 27, SetpNe = 28, SetpGt = 29, SetpGe = 30, SetpInv = 31, SetpPop = 32, SetpClr = 33, SetpRstr = 34,
        KillsEq = 35, KillsGt = 36, KillsGe = 37, KillsNe = 38, KillsOne = 39,
        Sqrt = 40, Mulsc0 = 42, Mulsc1 = 43, Addsc0 = 44, Addsc1 = 45, Subsc0 = 46, Subsc1 = 47,
        Sin = 48, Cos = 49, RetainPrev = 50
    };

    enum class AluVectorOpcode : uint32_t
    {
        Add = 0, Mul = 1, Max = 2, Min = 3, Seq = 4, Sgt = 5, Sge = 6, Sne = 7, Frc = 8, Trunc = 9, Floor = 10,
        Mad = 11, CndEq = 12, CndGe = 13, CndGt = 14, Dp4 = 15, Dp3 = 16, Dp2Add = 17, Cube = 18, Max4 = 19,
    ...
    // Vertex fetch data formats (xenos.h VertexFormat).
