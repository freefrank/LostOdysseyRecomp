...
Issue #5 调查中的两个缺失调用入口已修复，原报告战斗仍待复测。Issue #6 已补充启动内存诊断，原机器根因和恢复仍未知。新构建画质验收与更广游戏覆盖仍待完成。见[正式发布验证](docs/STATUS.md)、[开发证据](docs/notes/v0.4.0-development.md)和[后续记录](docs/notes/handoff-v0.4.0-followup.md)。
