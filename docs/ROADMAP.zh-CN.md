...
12. [x] GitHub Latest 数字版本更高，或数字版本相同但后缀不同时触发更新。独立更新器还支持在正式安装目录无参数启动，并保留 apply handshake。[v0.5.1](https://github.com/freefrank/LostOdysseyRecomp/releases/tag/v0.5.1) 已公开为 Latest，于 2026-09-10T05:31:57Z 从 commit `7ec5c7b6` 发布；CI 34440279121 通过。ZIP SHA256 为 `eb78828c00a9ae1329195f619c0a400721bc8b635e80c4a57b3a15912af359c5`，独立 updater SHA256 为 `19d2cd64d78545f5687139c87eff314f8ff0e9f20be8d5911baf9644ae261e11`。50 个 payload hash、源码/版本及匿名 ZIP/updater 下载均已核验。保留的策略、独立更新器宿主和打包检查分别为 14/0、43/0、7/0；未补做游戏/运行时检查，也未声称玩家验收。v0.5.1-updaterfix Release 已删除，tag 保留历史。
