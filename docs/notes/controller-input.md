...
Status: **2026-09-06, v0.2.1 release candidate, publication pending; not included in v0.2**. The input update opens all SDL-mapped game controllers and keeps the keyboard active. It merges them into player 1, not separate multiplayer slots.
