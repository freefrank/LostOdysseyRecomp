...
> 从 [交接入口](../../notes/handoff.md) 阅读当前结论、测试与待办；本文是按时间追加的历史分析。
> 下面的早期假设保留作调查记录；尤其“遮挡查询已排除”已被推翻。

> 2026-09-04 17 点之后的续接见 [handoff.md](../../notes/handoff.md)。最新普查澄清：75 次 mode 4 相对寻址候选中，
...
详见 [物理别名与渲染修复](../../notes/physical-alias-rendering.md)，其中记录 Ghidra 函数地址与查询布局。
